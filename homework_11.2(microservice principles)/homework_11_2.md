...
Соответственно, рассматриваем текущий кейс, что мы переводим текущий монолит не в облако, т.е. варианты Amazon API Gateway, Yandex API Gateway уже сразу отпадают.
